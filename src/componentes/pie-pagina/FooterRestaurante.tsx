...
export default function FooterRestaurante() {
  return (
    <footer className="bg-[#14212B] text-[#C99745] w-full pt-4 pb-4 px-4 md:px-14">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-16">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <img
            ...
            style={{
              filter:
                'brightness(0) saturate(100%) invert(66%) sepia(52%) saturate(614%) hue-rotate(6deg) brightness(92%) contrast(88%)',
            }}
          />
          <div className="flex flex-col gap-2 mt-0">
            ...
            >
              <img src={goldInsta} alt="Instagram" className="w-7 h-7" />
              Instagram
            </a>
            <a
              ...
              className="flex items-center gap-2 hover:underline"
            >
              <svg className="w-7 h-7" fill="#C99745" viewBox="0 0 24 24">
                <path d="M22,12A10,10,0,1,0,12,22V14.89H10V12h2V10.24C12,8.35,13,7.5,14.66,7.5a14.69,14.69,0,0,1,1.35.07V9.73h-.77c-.77,0-.92.36-.92.89V12h1.84l-.24,2.89H15.32V22A10,10,0,0,0,22,12Z" />
              </svg>
              Facebook
            </a>
          ...
          {/* Legal */}
          <div className="mt-2 flex flex-wrap gap-4 text-md text-[#C99745]/90">
        ...
        <div className="flex-1 flex flex-col items-center md:items-end justify-center gap-2">
          <h2 className="text-4xl font-light tracking-widest mb-2">CONTACTA</h2>
          <a
            href="mailto:contacto@restaurantevictoria.com"
            className="text-xl md:text-4xl font-light hover:underline mb-2"
          >
